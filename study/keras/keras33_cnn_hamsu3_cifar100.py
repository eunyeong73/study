...
Conv2D_1 = Conv2D(70, 2, padding='valid', activation='relu')(drp1)
Conv2D_2 = Conv2D(85, 2, padding='valid', activation='relu')(Conv2D_1)
drp2 = Dropout(0.3)(Conv2D_2)
