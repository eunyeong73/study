...
train_set = pd.read_csv(path + 'house_train.csv') # + 명령어는 문자를 앞문자와 더해줌  index_col=n n번째 컬럼을 인덱스로 인식
            
test_set = pd.read_csv(path + 'house_test.csv') # 예측에서 쓸거임  3
...
model.fit(x_train, y_train, epochs=1000, batch_size=300, verbose=10)
...
loss :  22640.736328125     
RMSE :  31504.78928947087
r2스코어 :  0.7997656568089997
