...
from tensorflow.python.keras.layers import Dense, Flatten, Conv1D, Input, Dropout
...
print(x_train.shape)  #(8708, 12)
print(x_test.shape)  #(2178, 12)
...
#Conv1D
# loss:  [4247.6416015625, 44.57368087768555]
# r2:  0.8616004656505449
# 걸린시간 :  26.181825637817383  