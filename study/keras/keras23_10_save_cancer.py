...
# model.save("./_save/keras23_10_save_model.h5")

model = load_model("./_save/keras23_10_save_model.h5")
...
# loss :  [0.07763522863388062, 0.9824561476707458, 0.02008187770843506]
