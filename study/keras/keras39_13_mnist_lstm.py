...
from tensorflow.python.keras.layers import Dense, LSTM, Conv2D, Flatten, MaxPooling2D
...
model.add(LSTM(units = 10, input_shape=(28*28,1)))   #(28,28)도 가능하다
