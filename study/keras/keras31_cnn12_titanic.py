...
from tensorflow.python.keras.layers import Conv2D, Flatten, Dense, Input, Dropout
...
print(x_train.shape, y_train.shape) #(712, 7) (712, 1)
print(x_test.shape, y_test.shape)  #(179, 7) (179, 1)
...
log = model.fit(x_train, y_train, epochs=100, batch_size=32, callbacks=[Es], validation_split=0.2)
...
model.save("./_save/keras23_18_save_model.h5")
# model = load_model("./_save/keras23_18_save_model.h5")
...
# loss :  6.80765962600708
# accuracy :  0.5586591958999634       
# acc스코어 :  0.5586592178770949