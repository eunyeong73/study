...
#2. 모델구성
model = Sequential()
model.add(Conv1D(10, 2, input_shape=(7,1)))  #(filter, kernel_size, input_shape)
model.add(Flatten())
model.add(Dense(100))
...
# loss :  0.5035430788993835
# accuracy :  0.7709497213363647
# acc스코어 :  0.770949720670391


# dropout 후
# loss :  0.500892162322998
# accuracy :  0.7597765326499939
# acc스코어 :  0.7597765363128491


# Conv1D
# loss :  0.5142755508422852       
# accuracy :  0.7709497213363647   
# acc스코어 :  0.770949720670391
# 걸린시간 :  3.9884743690490723  