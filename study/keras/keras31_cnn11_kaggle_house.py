...
print(x_train.shape, y_train.shape)  #(1003, 12) (1003,)
print(x_test.shape, y_test.shape)   #(335, 12) (335,)
...
###################리세이프#######################
x_train = x_train.reshape(1003, 4, 3, 1)
x_test = x_test.reshape(335, 4, 3, 1)
print(x_train.shape)
...
# oss :  [1218699648.0, 25013.515625] 
# r2스코어 :  0.7408825808579982
