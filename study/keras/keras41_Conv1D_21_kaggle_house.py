...
print(x_train.shape)  #(1003, 12)
print(x_test.shape)   #(335, 12)
...
#2. 모델구성
model = Sequential()
model.add(Conv1D(10, 2, input_shape=(12,1)))  #(filter, kernel_size, input_shape)
model.add(Flatten())
model.add(Dense(100))
...
model.save("./_save/keras23_17_save_model.h5")
# model = load_model("./_save/keras23_17_save_model.h5")
...
# loss :  [638975936.0, 17460.10546875]
# r2스코어 :  0.8641422424552487


# dropout 후
# loss :  [627875392.0, 17367.212890625]  
# r2스코어 :  0.8665024267297581

#Conv1D
# loss :  [734707840.0, 19505.45703125]
# 걸린시간 :  3.4290857315063477   
# r2스코어 :  0.8437879066143137