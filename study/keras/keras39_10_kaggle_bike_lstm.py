...
log = model.fit(x_train, y_train, epochs=100, batch_size=50, callbacks=[Es], validation_split=0.25)
...
#LSTM 후
# loss:  [5528.6787109375, 48.96385192871094]
# r2:  0.8295834785192494